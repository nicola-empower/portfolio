...
const ReclaimInfographicPage = () => {
    ...
    const chartTextColor = isDark ? '#E2E8F0' : '#000000'; // Pure black for max contrast in light mode
    const chartGridColor = isDark ? 'rgba(255, 255, 255, 0.1)' : 'rgba(0, 0, 0, 0.1)';
    const burgundyAccent = '#630625';
    const tealAccent = '#0d9488'; // Slightly darker teal for contrast
    const champagneAccent = '#F7E7CE';
    ...
    const bioData = {
        ...
        datasets: [{
            ...
            data: [6, 2, 1, 4],
            backgroundColor: [burgundyAccent, '#8E24AA', tealAccent, '#4F46E5'],
            borderRadius: 8,
        }]
    };
    ...
    const auditData = {
        ...
        datasets: [{
            data: [42, 12, 5],
            backgroundColor: [burgundyAccent, tealAccent, '#94a3b8'], // Darker grey
            borderWidth: 0,
            hoverOffset: 10
        }]
    };
        ...
        <div className="min-h-screen bg-background text-foreground font-sans transition-colors duration-500 leading-relaxed overflow-x-hidden">
            <nav className="sticky top-0 z-50 bg-background/80 backdrop-blur-md border-b border-card-border px-6 py-4 flex justify-between items-center">
                <div className="flex items-center gap-4">
                    <Link
                        href="/work/reclaim"
                        className="flex items-center gap-2 text-foreground/90 hover:text-[#630625] transition-colors font-bold border-r border-card-border pr-4"
                    >
                        <ArrowLeft size={18} />
                        Back to Project
                    </Link>
                    <Link
                        href="/intelligence"
                        className="flex items-center gap-2 text-foreground/90 hover:text-[#630625] transition-colors font-bold"
                    >
                        System Intelligence
                    </Link>
                </div>
            ...
            <header className="bg-card-bg border-b border-card-border">
                <div className="max-w-7xl mx-auto py-20 px-8 text-center">
                    <div className="flex justify-center mb-8">
                        <div className="bg-[#630625] p-5 rounded-3xl shadow-[0_0_30px_rgba(99,6,37,0.3)] ring-8 ring-[#630625]/10 rotate-3">
                    ...
                    <h2 className="text-2xl md:text-3xl font-bold text-[#630625] mb-6 uppercase tracking-[0.2em]">
            ...
            <main className="max-w-7xl mx-auto p-6 md:p-12 space-y-12">
                {/* Core Value Section */}
                <section className="bg-background border-2 border-[#630625]/20 rounded-[3rem] p-10 md:p-16 text-foreground shadow-2xl relative overflow-hidden group">
                    <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#630625]/5 rounded-full -mr-64 -mt-64 blur-[120px]"></div>
                    <div className="relative z-10 flex flex-col md:flex-row gap-12 items-center">
                        <div className="flex-1">
                            <h3 className="text-4xl md:text-5xl font-serif italic font-bold mb-8 text-[#630625]">
                                Reclaim
                            </h3>
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                                <div className="bg-card-bg border border-[#630625]/40 rounded-2xl p-6 shadow-lg">
                                    <h4 className="font-bold text-[#630625] text-2xl mb-1 tracking-tighter italic font-serif leading-none">42</h4>
                                    <p className="text-[10px] uppercase tracking-widest text-foreground font-bold">Pruned / Day</p>
                                </div>
                                <div className="bg-card-bg border border-[#630625]/40 rounded-2xl p-6 shadow-lg">
                                    <h4 className="font-bold text-[#630625] text-2xl mb-1 tracking-tighter italic font-serif leading-none">124ms</h4>
                                    <p className="text-[10px] uppercase tracking-widest text-foreground font-bold">Fault Recovery</p>
                                </div>
                                <div className="bg-card-bg border border-[#630625]/40 rounded-2xl p-6 shadow-lg">
                                    <h4 className="font-bold text-[#630625] text-2xl mb-1 tracking-tighter italic font-serif leading-none">100%</h4>
                                    <p className="text-[10px] uppercase tracking-widest text-foreground font-bold">Privacy SLA</p>
                                </div>
                                <div className="bg-card-bg border border-[#630625]/40 rounded-2xl p-6 shadow-lg">
                                    <h4 className="font-bold text-[#630625] text-2xl mb-1 tracking-tighter italic font-serif leading-none">£17k</h4>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    <section className="bg-card-bg rounded-[2.5rem] p-10 border border-card-border shadow-xl">
                        <div className="flex items-center gap-4 mb-8">
                            <div className="bg-[#630625]/10 p-3 rounded-2xl">
                                <Newspaper className="text-[#630625]" size={24} />
                            </div>
                            <div>
                                <h3 className="text-2xl font-serif font-bold italic">Strategic Synthesis</h3>
                                <p className="text-xs uppercase tracking-widest text-[#630625] font-black">The Sector Audit Engine</p>
                            </div>
                        </div>
                    ...
                    <section className="bg-card-bg rounded-[2.5rem] p-10 border border-card-border shadow-xl">
                        <div className="flex items-center gap-4 mb-8">
                            ...
                            <div>
                                <h3 className="text-2xl font-serif font-bold italic">Biometric Readiness</h3>
                                <p className="text-xs uppercase tracking-widest text-teal-800 dark:text-teal-400 font-black">The Sanctuary Protocol</p>
                            </div>
                        </div>
                        ...
                        <p className="text-sm text-foreground font-bold leading-relaxed italic border-l-4 border-teal-500/50 pl-6">
                ...
                <section className="bg-card-bg rounded-[3rem] p-10 md:p-16 border border-card-border">
                    <h3 className="text-4xl font-serif font-bold italic mb-12 flex items-center gap-6 text-[#630625]">
                        <RefreshCcw className="text-[#630625]" size={40} />
                        The State Pipeline
                    </h3>
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        {[
                            { step: '01', title: 'Director Scan', desc: 'Synthesising inbox, calendar, and 40+ newsletters via Gemini 3 Pro.', color: burgundyAccent },
                            { step: '02', title: 'Context Audit', desc: 'Pruning high-decibel noise into strategic operational pillars.', color: burgundyAccent },
                            { step: '03', title: '5:30 Boundary', desc: 'The "Hard Switch" from CEO Mode to Mum Mode ritual.', color: burgundyAccent },
                            { step: '04', title: 'Sanctuary Sync', desc: 'Transitioning to human rituals and bio-metric restoration.', color: burgundyAccent }
                        ].map((item, idx) => (
                            <div key={idx} className="bg-background border border-card-border group hover:border-[#630625]/50 transition-all relative overflow-hidden p-8 rounded-[2.5rem]">
                                <span className="text-5xl font-black text-[#630625]/10 absolute top-4 right-6 group-hover:text-[#630625]/20 transition-colors font-serif">{item.step}</span>
                                <h4 className="font-serif italic font-bold text-xl mb-4 text-[#630625]">{item.title}</h4>
                ...
                <section className="bg-card-bg rounded-[3rem] p-10 md:p-20 border border-card-border shadow-2xl relative overflow-hidden group">
                    ...
                    <div className="max-w-4xl mx-auto relative z-10">
                        <h3 className="text-3xl md:text-5xl font-serif italic text-[#630625] font-bold mb-12 text-center">
                            The Resilience Layer
                        </h3>

                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
                            {/* Step 1: Input */}
                            <div className="bg-background border border-card-border p-8 rounded-[2.5rem] relative group hover:border-[#630625]/50 transition-all">
                                <div className="bg-[#630625]/10 w-12 h-12 rounded-2xl flex items-center justify-center mb-6 text-[#630625]">
                                    <Database size={24} />
                                </div>
                                ...
                                <div className="hidden md:block absolute -right-4 top-1/2 -translate-y-1/2 z-20">
                                    <div className="w-8 h-px bg-[#630625]/50"></div>
                                </div>
                            </div>

                            {/* Step 2: Filter */}
                            <div className="bg-[#630625]/5 border-2 border-[#630625]/20 p-8 rounded-[2.5rem] relative shadow-lg">
                                <div className="bg-[#630625] w-12 h-12 rounded-2xl flex items-center justify-center mb-6 text-white shadow-lg">
                                    <Lock size={24} />
                                </div>
                                <h4 className="font-serif italic font-bold text-xl mb-3 text-[#630625]">String Cannon™</h4>
                                <p className="text-xs text-foreground font-medium leading-relaxed">
                                    The proprietary "Reality-Sync" engine that enforces data integrity and isolates AI hallucinations in real-time.
                                </p>
                                <div className="hidden md:block absolute -right-4 top-1/2 -translate-y-1/2 z-20">
                                    <div className="w-8 h-px bg-[#630625]/30"></div>
                                </div>
                            </div>

                            {/* Step 3: Output */}
                            <div className="bg-background border border-card-border p-8 rounded-[2.5rem]">
                                <div className="bg-teal-500/10 w-12 h-12 rounded-2xl flex items-center justify-center mb-6 text-teal-600">
                                    <Shield size={24} />
                                </div>
                        ...
                        <div className="mt-16 p-10 bg-[#630625]/5 rounded-[2.5rem] border border-[#630625]/20 text-center">
                ...
                <section className="bg-accent-secondary/5 rounded-3xl p-10 border border-card-border">
                    <h3 className="text-sm font-bold text-[#630625] uppercase tracking-[0.3em] mb-8 text-center">Reclaim Intelligence Stack</h3>
                    <div className="flex flex-wrap justify-center gap-4">
                        {[
                            ...
                            <span
                                key={tech}
                                className="px-8 py-3 bg-[#630625] rounded-2xl text-white font-bold text-xs shadow-lg uppercase tracking-widest"
                            >
                                {tech}
                            </span>
                        ))}
            ...
            <footer className="text-center py-20 border-t border-card-border text-foreground font-bold">
                ...
                <div className="flex justify-center gap-10 mt-10">
                    <Database size={20} className="hover:text-[#630625] transition-colors cursor-pointer" />
                    <Cpu size={20} className="hover:text-[#630625] transition-colors cursor-pointer" />
                    <Smartphone size={20} className="hover:text-[#630625] transition-colors cursor-pointer" />
                </div>
            </footer>
        </div>
    );
