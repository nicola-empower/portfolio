            ...
            <div className="relative z-10 container mx-auto px-6 text-center">
                ...
                >
                    <div className="flex flex-col items-center gap-4 mb-6">
                        <span className="px-4 md:px-5 py-2 bg-foreground/5 dark:bg-white/5 border border-foreground/20 dark:border-white/10 text-foreground/80 dark:text-white/60 rounded-full text-[9px] md:text-xs font-bold tracking-[0.2em] md:tracking-[0.4em] uppercase backdrop-blur-sm text-center">
                        ...
                        <motion.div
                            ...
                            className="group relative flex items-center gap-3 md:gap-4 px-4 md:px-6 py-2 md:py-2.5 bg-[#4A0E0E]/80 dark:bg-[#4A0E0E]/40 backdrop-blur-md border border-[#D4A84F]/50 dark:border-[#D4A84F]/30 rounded-full shadow-[0_5_15px_rgba(74,14,14,0.1)] hover:shadow-[0_8_25px_rgba(74,14,14,0.15)] transition-all duration-500 cursor-default max-w-[90vw] md:max-w-none"
                        >
                            {/* Left Laurel */}
...
<span className="text-[#D4A84F] text-[9px] md:text-xs font-bold uppercase tracking-[0.15em] md:tracking-[0.25em] drop-shadow-sm text-center">
                            ...
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-[#D4A84F] opacity-90 group-hover:opacity-100 transition-opacity transform -scale-x-100 shrink-0">
