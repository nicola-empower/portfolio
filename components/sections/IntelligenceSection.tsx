            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-20">
                    <div className="max-w-2xl">
                        <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold text-heading mb-6">
                            System <br />
                    ...
                    <Link href="/intelligence" className="hidden md:block">
                        <Button variant="outline" className="group border-accent-primary/50 text-accent-primary hover:bg-accent-primary hover:text-accent-primary-foreground">
                            Access All Dossiers
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {featuredDossiers.map((dossier) => (
                        <Link href={dossier.url} key={dossier.slug} className="group flex flex-col h-full bg-card-bg border border-foreground/10 rounded-2xl overflow-hidden hover:border-accent-primary/40 transition-all duration-300">
                            <div className="p-8 grow flex flex-col">
                                ...
                                <h3 className="font-serif text-2xl font-bold text-heading mb-4 group-hover:text-accent-primary transition-colors">
                                    {dossier.title}
                                </h3>
                ...
                <div className="mt-16 text-center md:hidden">
                    <Link href="/intelligence">
                        <Button variant="outline" size="lg" className="w-full border-accent-primary text-accent-primary hover:bg-accent-primary hover:text-accent-primary-foreground">
                            Access All Dossiers
                        </Button>
                    </Link>
                </div>
